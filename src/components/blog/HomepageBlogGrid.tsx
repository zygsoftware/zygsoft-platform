    ...
    if (posts.length === 0) {
        return (
            <motion.div
                ...
                className="h-[320px] bg-white/60 border border-[#343131]/[0.06] rounded-xl flex flex-col items-center justify-center text-center p-8"
            >
                <BookOpen size={48} className="text-[#343131]/20 mb-4" />
                <h3 className="text-xl font-display font-bold text-[#0e0e0e] mb-2">
                    {locale === "tr" ? "Henüz yazı yok" : "No posts yet"}
                </h3>
                <p className="text-[#343131]/50 text-sm max-w-xs">
