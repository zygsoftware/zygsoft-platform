  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f3f4f6;padding:40px 16px">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb">
        ...
        <tr><td style="background:#f9fafb;border-top:1px solid #e5e7eb;padding:16px 32px">
          <p style="margin:0;font-size:11px;color:#9ca3af;text-align:center">ZYGSOFT — Bu mesaj otomatik olarak gönderilmiştir. Panel: <a href="${process.env.NEXTAUTH_URL || "https://www.zygsoft.com"}/panel" style="color:#e6c800">Panel</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f3f4f6;padding:40px 16px">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb">
        ...
        <tr><td style="background:#f9fafb;border-top:1px solid #e5e7eb;padding:16px 32px">
          <p style="margin:0;font-size:11px;color:#9ca3af;text-align:center">ZYGSOFT — This message was sent automatically. Dashboard: <a href="${process.env.NEXTAUTH_URL || "https://www.zygsoft.com"}/en/dashboard" style="color:#e6c800">Dashboard</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
