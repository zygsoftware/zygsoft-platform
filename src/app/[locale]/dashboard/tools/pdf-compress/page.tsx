            ...
            <div className="max-w-5xl relative z-10">
                ...
                <div className="mb-10 border-b border-[#343131]/8 pb-8">
                    <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
                        <div>
                            <h1 className="mb-3 text-3xl md:text-4xl font-display font-black tracking-tight text-[#343131]">{tCmp("title")}</h1>
                            <p className="max-w-2xl text-[16px] leading-8 text-[#343131]/60">{tCmp("description")}</p>
                        </div>
                    </div>
                </div>
