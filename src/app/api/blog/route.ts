    ...
    try {
        ...
        const post = await prisma.blogPost.create({
            data: {
                ...
                cover_image_alt_tr: cover_image_alt_tr?.trim() || null,
                cover_image_alt_en: cover_image_alt_en?.trim() || null,
                cover_image_title_tr: cover_image_title_tr?.trim() || null,
                cover_image_title_en: cover_image_title_en?.trim() || null,
                cover_image_caption_tr: cover_image_caption_tr?.trim() || null,
                cover_image_caption_en: cover_image_caption_en?.trim() || null,
