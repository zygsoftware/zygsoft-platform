    ...
    return (
        <div className="flex min-h-screen bg-[var(--bg-2)]">
            ...
            <div className="flex-1 min-w-0 ml-64 flex flex-col min-h-screen">
                {/* Top bar */}
                <header className="sticky top-0 z-10 min-h-[72px] shrink-0 bg-white/90 backdrop-blur-xl border-b border-slate-200/80 px-8 py-4 flex items-center justify-between gap-4 shadow-sm">
                    <div className="flex flex-col gap-0.5 min-w-0">
                        <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold leading-none">ZYGSOFT</p>
                        <h2 className="text-sm font-bold text-slate-900 tracking-tight leading-tight">Yönetim Paneli</h2>
                    </div>
                ...
                <main className="flex-1 min-w-0 px-8 pt-8 pb-8 relative overflow-hidden">
                    ...
                    <div className="relative z-10 min-w-0 w-full max-w-full pt-6">
                        {children}
                    </div>
                </main>
            </div>
