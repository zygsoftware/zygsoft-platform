...
| `NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION` | No | Google Search Console HTML verification token. If set, Next metadata emits the verification meta tag automatically. |
